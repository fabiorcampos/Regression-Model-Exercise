...
The results of this study verify that the manual transmission should be better than automatic transmission for mpg if we consider only these element(transmission). 
